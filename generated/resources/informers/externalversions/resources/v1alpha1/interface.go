...
// BentoRequests returns a BentoRequestInformer.
func (v *version) BentoRequests() BentoRequestInformer {
	return &bentoRequestInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
